...
func TestAccountHandlerSimpleModeUsesMinimalGroupReferences(t *testing.T) {
	...
	h := NewAccountHandler(svc, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
...
func TestAccountHandlerAdvancedModeKeepsFullGroupReferences(t *testing.T) {
	...
	h := NewAccountHandler(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil)
