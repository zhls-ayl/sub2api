...
services:
  sub2api:
    image: ghcr.io/nianzs/sub2api:latest
    ports:
      - "8080:8080"
    environment:
...
- [GitHub Repository](https://github.com/nianzs/sub2api)
- [Documentation](https://github.com/nianzs/sub2api#readme)
